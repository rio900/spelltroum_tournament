...
pub mod spelltroum_tournament {
    ...
    // Еще в работе потому открыт на мир
    // в будущем будет вызыватся только с trusted authority
    pub fn settle_match<'info>(
        ...
        // Сделано чтобы случайно не засеттлить матч дважды
        require!(
            ctx.accounts
                .match_history
                .settled_matches
        ...
        // Добавляем матч в историю чтобы не засеттлить его дважды
